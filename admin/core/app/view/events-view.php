...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		<form class="form-horizontal" enctype="multipart/form-data" method="post" id="addcategory" action="index.php?action=events&opt=add" role="form">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-4 control-label">Fecha de inicio*</label>
    <div class="col-md-6">
      <input type="date" name="start_at" required class="form-control" id="title" placeholder="Fecha inicial">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-4 control-label">Fecha de fin*</label>
    <div class="col-md-6">
      <input type="date" name="finish_at" required class="form-control" id="title" placeholder="Titulo">
    </div>
  </div>
...
<a href="index.php?action=events&opt=del&id=<?php echo $user->id;?>" class="btn btn-danger btn-xs">Eliminar</a></td>
				</tr>
				<?php
...
<div class="modal fade" id="editModal<?php echo $user->id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		<form class="form-horizontal" method="post" id="addproduct" action="index.php?action=events&opt=update" role="form">
  ...
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-4 control-label">Fecha de inicio*</label>
    <div class="col-md-6">
      <input type="date" name="start_at" required class="form-control" value="<?php echo $user->start_at;?>" id="title" placeholder="Fecha inicial">
    </div>
  </div>
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-4 control-label">Fecha de fin*</label>
    <div class="col-md-6">
      <input type="date" name="finish_at" required class="form-control" value="<?php echo $user->finish_at;?>" id="title" placeholder="Titulo">
    </div>
  </div>
