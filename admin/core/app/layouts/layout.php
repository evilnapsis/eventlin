...
<html>
  <head>
    <meta charset="UTF-8">
    <title>EVENTLIN | Panel de Administracion</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="./" class="logo">
          ...
          <span class="logo-lg"><b>EVENTLIN</b></span>
        </a>
...
<div class="user-panel">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="./index.php?view=events&opt=all"><i class='fa fa-calendar'></i> <span>Eventos</span></a></li>
